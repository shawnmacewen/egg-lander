...
## 4) Scoring & Progression (Current Decision)
...
## 5) Landing Design (Current Decision)
...
## 6) Session/Reset Behavior (Current Decision)
...
## 7) Level Structure (Current Decision)
...
## 8) Persistence / Save System (Current Decision)
...
## 10) MVP Definition (Current)
MVP is considered complete when all of the following exist:
- Playable keyboard-controlled lander loop.
...
## 11) Open Items (for post-MVP tuning)
